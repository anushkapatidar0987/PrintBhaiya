...
export default function LandingPage() {
  ...
  const [shops] = useState(mockDb.getShops(true));
        ...
        <div className="container grid-2" style={styles.heroContainer}>
          <div style={styles.heroTextCol}>
            ...
            <div style={styles.heroBtns}>
              <Link to="/auth?mode=register" className="btn btn-primary">Join as Shopkeeper</Link>
              <Link to="/auth?mode=login" className="btn btn-accent">Order Prints</Link>
            </div>
          </div>
          ...
          <div className="grid-2">
            ...
            <div className="card-dark" style={styles.serviceCard}>
              <div style={styles.serviceCardContent}>
                ...
                <span style={styles.servicePrice} style={{color: 'var(--neon-green)', fontWeight: 'bold'}}>Starts at ₹8.00/page</span>
              </div>
            </div>
